...
## [2026-06-21] Агент: Claude Code | Сессия: Создание агента presentations

### Что сделано
- Создан opencode-агент `@presentations` для работы с презентациями
- Агент умеет: генерировать из Markdown (Marp, Slidev), редактировать .pptx (python-pptx), конвертировать форматы

### Что изменилось в файлах
- `.opencode/agents/presentations.md` — новый файл агента

### Следующие шаги
- Установить зависимости: `pip install python-pptx`, `npm install -g @marp-team/marp-cli`

---

## [2026-06-21] Агент: Claude Code | Сессия: Рефакторинг build.js (грант-презентация)

### Что сделано
- Добавлен `pageNum(s, 10, true)` на финальный слайд (раньше отсутствовал номер страницы)
- Фикс дублирования палитры в цикле бюджета — убрана переопределённая `colors`, используется существующая `palette`
- Шрифт Georgia заменён на Times New Roman (казахские символы Ә, Ғ, Қ, Ң, Ө, Ұ, Ү, І не гарантированы в Georgia на всех системах)

### Что изменилось в файлах
- `grant-presentation/build.js` — 3 правки
