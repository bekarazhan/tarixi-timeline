...
(async () => {
  ...
  // ========================================================
  {
    ...
    s.addText("Қазақстан тарихын әлемдік тарих пен жаһандық мәдени контексте көрсетіп, тарихи тұлғалармен ЖИ-сұхбат арқылы жақындататын интерактивті платформа.", { x: 0.9, y: 3.35, w: 10.2, h: 1.0, margin: 0, fontFace: FONT_B, fontSize: 19, color: C.text2, lineSpacingMultiple: 1.15 });
  ...
  // ========================================================
  {
    ...
    const mods = [
      ...
      { icon: ic.robot, t: "Тарихи тұлғалармен ЖИ-сұхбат", d: "Генеративті тіл модельдері (LLM) негізінде Қазақстанның тарихи тұлғаларының виртуалды бейнелерімен тірі диалог. Әр агент дәуірге сай мінез бен дәйектілікке ие." },
    ];
    let mx = 0.7;
    mods.forEach((m) => {
  ...
  // ========================================================
  {
    ...
    const steps = [
      ...
      { n: "02", icon: ic.comments, t: "Тұлғамен сөйлесу", d: "Әл-Фараби, Абай немесе хан-билермен ЖИ арқылы сұхбаттасады - нақты адаммен сөйлескендей." },
  ...
  // ========================================================
  {
    ...
    s.addText("Объектіні таңдағанда фото, сипаттама және ЖИ-сұхбатты ашатын «Поговорить» батырмасы көрінеді.", { x: 8.5, y: dY + dH + 0.12, w: 4.15, h: 0.7, margin: 0, fontFace: FONT_B, fontSize: 12, color: C.text2, lineSpacingMultiple: 1.15 });
    pageNum(s, 5);
  }

  // ========================================================
  // СЛАЙД 6 - Интерфейс (ЖИ-сұхбат)
  // ========================================================
  {
    const s = pres.addSlide();
    s.background = { color: C.bg };
    kicker(s, "Интерфейс · Инновация");
    title(s, "Тарихи тұлғалармен ЖИ-сұхбат");
    ...
    const feats = [
      { icon: ic.robot, t: "Дәуірге дәйекті ЖИ-агенттер", d: "Әр тұлғаның мінезі, білімі мен дәуір контексі сақталады." },
  ...
  // ========================================================
  {
    ...
    const aud = [
      { icon: ic.grad, big: "Оқушылар мен студенттер", sub: "Тарих пен мәдениетке қызығатын жастар" },
      { icon: ic.book, big: "Қосымша білім", sub: "Тарих бойынша курстар мен орталықтар" },
  ...
  // ========================================================
  {
    ...
    const phases = [
      ...
      { q: "2-кезең", t: "ЖИ-сұхбат", d: "LLM интеграциясы,\nагенттер контексі" },
